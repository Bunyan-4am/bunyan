...
const testimonials = [
  ...
  {
    quote:
      "The AI-powered bill scanning alone saved us over SAR 800K in the first quarter. The environmental compliance reports are a game-changer for our audits.",
  ...
  {
    quote:
      "Bunyan's analytics dashboard gives us real-time visibility into every project's carbon footprint. It's essential for meeting Vision 2030 sustainability targets.",
